package curiousity.fundamental.inheritence;

import curiousity.fundamental.inheritence.abstractnote.ExampleAbstract;
import curiousity.fundamental.inheritence.abstractnote.MathCalculator;
import curiousity.fundamental.inheritence.extendsnote.BluetoothMouse;
import curiousity.fundamental.inheritence.extendsnote.GamingMouse;
import curiousity.fundamental.inheritence.extendsnote.MouseBase;
import curiousity.fundamental.inheritence.interfacenote.ExampleInterface;
import curiousity.fundamental.inheritence.interfacenote.impl.ExampleInterfaceImpl;
import curiousity.fundamental.inheritence.superconstructor.CartStatusEnum;
import curiousity.fundamental.inheritence.superconstructor.CartTypeEnum;
import curiousity.fundamental.inheritence.superconstructor.CartV2;
