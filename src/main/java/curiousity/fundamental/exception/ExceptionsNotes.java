...
public class ExceptionsNotes {
    ...
    public static void main(String[] args) {
        ...
        /** Output :
         * curiousity.fundamental.exception.MyCustomException: Balance is less than 1000
         * at curiousity.fundamental.exception.ExceptionsNotes.main(ExceptionsNotes.java:86)
         */
